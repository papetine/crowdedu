 ...
 */
final class Version20190214124953 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet ADD user_id INT DEFAULT NULL, ADD statut INT NOT NULL, ADD subvention TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE projet DROP user_id, DROP statut, DROP subvention');
    }
}
